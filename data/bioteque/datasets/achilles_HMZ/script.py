...
def generate_graph_csv(db,dt,metaedge,attribute_index=3,attribute=None,map_attribute=False):
    ...
    #Variables
    w2mp = {1:'PGN-gfn-CLL',-1:'PGN-bfn-CLL'} #Added manually
    all_pgns = set([])
    ...
    #4) Parsing the data
    sys.stderr.write('Parsing the data...\n')
    c = -1
    g2depCLs = {}
    pg2gns = {}
...
#-------------------------------------------------------------------------------------------
#RUN
metaedge = ['PGN-gfn-CLL','PGN-bfn-CLL','PGN-pdw-GEN']
db = 'achilles'
