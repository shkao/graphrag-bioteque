...
g2signs = {}
with open('./dhimmel-lincs-8e9c56a/data/consensi/signif/dysreg-knockdown.tsv','r') as f:
    f.readline()
    for l in f:
        h = l.rstrip('\n').split('\t')
...
ofile_pgn_int = open(out_path+'/PGN-pdw-GEN/%s.tsv'%source, 'w')
