...
with open('./all_gene_disease_associations.tsv','rb') as f:
    ...
    for l in f:
        ...
        if befree_source not in set(h[-1].split(';')): continue
        gid = h[0].strip()
        dis = 'UMLS:'+h[4]
        ...
        m.append([gid,dis,score,spc,plt])
...
with open(out_path+'/GEN-ass-DIS/%s.tsv'%source,'w') as o:
    o.write('n1\tn2\tscore\tspecificity\tpleiotropy\n')
    for r in m:
        gid,dis,s,spc,plt =  str(r[0]),r[1],r[2],r[3],r[4]
